...
<div class = "grid-container">
    <div class="grid-item header">
        <h1>AlgoNest🔥</h1>
        <form action="/src/views/users/LogIn.php" method="POST">
    ...
    <div class="grid-item main-container">
        ...
        <div id="background">
            <img src="/public/assets/images/Background.png" alt="Background Image">
        </div>

        <div class="content-wrapper">
            <div class="content-row">
                <img src="/public/assets/images/Visualize.png" alt="Visualize Icon" class="left-image">
                <h1 class="background-heading">Visualize</h1>
            </div>

            <div class="content-row">
                <h1 class="background-heading">Learn</h1>
                <img src="/public/assets/images/Learn.png" alt="Learn Icon" class="right-image">
            </div>

            <div class="content-row">
                <img src="/public/assets/images/Master.png" alt="Master Icon" class="left-image">
