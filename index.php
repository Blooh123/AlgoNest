        ...
        <div class="grid-item main-container">
            ...
            <div class="content-wrapper">
                <div class="content-row">
                    <img src="Images/Visualize.png" alt="Visualize Icon" class="left-image">
                    <h1 class="background-heading">Visualize</h1>
                </div>

                <div class="content-row">
                    <h1 class="background-heading">Learn</h1>
                    <img src="Images/Learn.png" alt="Learn Icon" class="right-image">
                </div>

                <div class="content-row">
                    <img src="Images/Master.png" alt="Master Icon" class="left-image">
